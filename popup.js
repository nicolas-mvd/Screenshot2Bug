...
var root = app;
var DONATE_URL = "https://buymeacoffee.com/screenshot2bug";
var session;
var sessions = [];
var steps = "";
var notes = "";
    ...
    <section class="shell popup-shell">
      <header class="popup-appbar">
        ...
        <div class="topbar-actions">
          <button class="icon-button large donate-button" id="donateButton" title="Support Screenshot2Bug" aria-label="Support Screenshot2Bug">\u2661</button>
