...
function render() {
  ...
  document.querySelector("#repoSelect")?.addEventListener("change", (event) => void selectRepo(event.target.value));
...
async function connectGitHub() {
  ...
  const githubDefaultLabels = parseLabels(document.querySelector("#githubLabelsInput")?.value ?? "bug");
  if (!githubClientId) {
